"""View model implementation for Galaxy tool example."""
...
class ViewModel:
    ...
    def store_factory(self) -> str:
        # This will cause a history named "fractals" to be created on Galaxy to store the tool's outputs, errors, and
        # results.
        return "fractals"
